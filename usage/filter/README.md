...
### Version and Users
Filter on versioning by selecting one or more versions. You can filter on actions taken on an Object, Categorie or Reversed Classification by specifying whether it has been audited or not. Specify a Date Start and Date End to filter on when an Object, Categorie or Reversed Classification was changed. You can filter to include or exclude Object, Categorie or Reversed Classification handled by yourself or other users.